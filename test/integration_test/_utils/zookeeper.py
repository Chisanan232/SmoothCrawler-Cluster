...
class TestZookeeperClient:
    ...
    def test_exist_path_with_exist_path(self, zk_cli: Generic[_BaseZookeeperClientType]):
        ...
        assert zk_cli.exist_path(path=Test_Zookeeper_Path) is not None, "It should exist the path (node) it created."
    ...
    def test_exist_path_with_not_exist_path(self, zk_cli: Generic[_BaseZookeeperClientType]):
        ...
        assert zk_cli.exist_path(path=Test_Zookeeper_Not_Exist_Path) is None, "It should NOT exist the path (node)."
    ...
    def test_set_value_to_path(self, zk_cli: Generic[_BaseZookeeperClientType]):
        ...
        assert zk_cli.get_path(path=Test_Zookeeper_Path).value == _new_value, f"The new value of *ZookeeperPath* should be equal to {_new_value} (by function *get_path*) because it has been modified."
        assert zk_cli.get_value_from_path(path=Test_Zookeeper_Path) == _new_value, f"The new value of *ZookeeperPath* should be equal to {_new_value} (by function *get_value_from_path*) because it has been modified."
